...
class GifCollRouter: NSObject, GifCollRoutingLogic, GifCollDataPassing
{
  ...
  //func navigateToSomewhere(source: GifCollViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: GifCollDataStore, destination: inout SomewhereDataStore)
  //{
